...
<header>
	<div class = "row">
		<div class=col-1></div>
		<form action="/cake/Model/index" method="get">
			<a href="http://localhost/cake/Model/index"><img src="<?=$img?>" border="0"></a>
		</form>
            <div class ="col-5"></div>
				<form action="/cake/model/mpd" method="get">
					<input class="btn btn-dark mt-4 mr-3" type="submit" value="マイページ">
				</form>
				<form action="/cake/Commons/logout" method="get">
...
<div class="menu">
	<div class="row ">
		...
		<form action="/cake/Commons/cr" method="get">
