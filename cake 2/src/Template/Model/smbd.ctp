<div class="jumbotronsmbd">
    <div class="namelavelsmbd text-white">応募済み掲示板詳細</div>
    <?php foreach($result as $obj):?>
    <div class="backsmbd container pt-0">
        <div class="row"> 
        ...
        <div class="row">       
                <div class="back2mbd col-3 ml-3">
                    <div class="imazinembd ml-0 mr-0">
                    <img class="adaptsmbd" alt="" src="../img/single4.PNG">
                    </div>
